      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center">
          ...
          <div className="flex justify-center space-x-8 mb-8">
            {/* GitHub Link */}
            <a
              href="https://github.com/shreyasd-24"
              target="_blank"
            ...
            {/* LinkedIn Link */}
            <a
              href="https://linkedin.com/in/shreyasd-20"
              target="_blank"
              rel="noopener noreferrer"
              className="group flex items-center space-x-2 text-gray-400 hover:text-white transition-all duration-300 transform hover:scale-110"
            >
              <svg
                className="w-6 h-6 group-hover:text-cyan-400 transition-colors duration-300"
                fill="currentColor"
                viewBox="0 0 24 24"
              >
          ...
          <div className="text-gray-500 text-sm">
            <p>&copy; 2025 Docex. All rights reserved.</p>
          </div>
        </div>
      </div>
    </footer>
